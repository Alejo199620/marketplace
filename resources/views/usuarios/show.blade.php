...
<div class="container">
    <div class="row">
        <div class="col-lg-4 mb-4 text-center">
            <div class="mb-4">
                @if($usuario->imagen)
                    <img src="{{ url('img/usuarios/' . $usuario->imagen) }}" class="user-image" alt="{{ $usuario->nombre }}">
                @else
                    <img src="{{ url('img/usuarios/avatar.png') }}" class="user-image" alt="Imagen por defecto">
                @endif
            </div>
