            ...
            @foreach ($data as $categoria)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ url('categorias/' . $categoria->id . '/edit') }}" class="btn btn-default"
                            title="Editar">
                        ...
                        <form action="{{ route('categorias.destroy' , $categoria->id) }}" method="POST"
                            ...
                            <button type="submit" class="btn btn-default" title="Eliminar">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                    ...
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    <path d="M4 7l16 0" />
                                    <path d="M10 11l0 6m4 -6l0 6m-5 -10l1 -1h4l1 1m-6 1v10a2 2 0 0 0 2 2h6a2 2 0 0 0 2 -2v-10m-10 -1h10a1.5 1.5 0 0 1 .5 .09m-11 -1.09v-2a1.5 1.5 0 0 1 .5 -1.09m11 .09h-10a1.5 1.5 0 0 1 -.5 -1.09v-2a1.5 1.5 0 0 1 .5 -1.09m10 .09h-10a1.5 1.5 0 0 0 -.5 1.09v2a1.5 1.5 0 0 0 .5 1.09" />
                                </svg>
                            </button>
                        </form>
                    </td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nombre" id="nombre"
                                placeholder="Ej: Camisas" required autofocus value="{{ old('nombre') }}">
                            @error('nombre')
